...
@Component({
  selector: 'app-quality-control-pledge-bioanalysis-sample-bs-index',
  templateUrl: './bs-index.component.html',
})
export class QualityControlPledgeBioanalysisSampleBsIndexComponent implements OnInit {
