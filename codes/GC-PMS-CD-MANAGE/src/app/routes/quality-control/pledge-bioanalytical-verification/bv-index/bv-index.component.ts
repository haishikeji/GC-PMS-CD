...
@Component({
  selector: 'app-quality-control-pledge-bioanalytical-verification-bv-index',
  templateUrl: './bv-index.component.html',
})
export class QualityControlPledgeBioanalyticalVerificationBvIndexComponent implements OnInit {
